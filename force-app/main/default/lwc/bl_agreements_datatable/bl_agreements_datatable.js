 ...
 */        }
   ...
   /*  @wire(getObjectInfo, { objectApiName: PRODUCT_OBJECT })
    ...
    columns = [
        ...
        {label: 'UOM', initialWidth: 80,fieldName: 'uOM' , type: 'text',editable:true},
        {label: '$',initialWidth: 70,fieldName: 'cur'  , type: 'text'},

        {label: 'Price',initialWidth: 80, fieldName: 'fixedPrice' , type: 'number',},
        {label: 'Price Adj', initialWidth: 80,fieldName: 'fixedPriceAdj', editable: true , type: 'number'},
        {label: 'Adder',initialWidth: 80 ,fieldName: 'varPriceAdj', editable: true , type: 'number'},
